...
def createDirs(rootRowDataPath, rootDataPath, dirs, lasers):
    ...
    for d in dirs: # ['DowglasForward', 'oneDouglasForward', 'oneDouglasNormal', 'twoDouglasOpposite', 'twoDouglasWalking']
        for l in lasers:
            for shapesN in range(4): # I check that we have max 4 shapes in png files
