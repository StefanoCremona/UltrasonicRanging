...
data_dir = pathlib.Path("C:/Users/e7470/data/train")
test_dir = pathlib.Path("C:/Users/e7470/data/test")
...
roses = list(data_dir.glob(CLASS_NAMES[0] + '/*'))

print("Samples from " + CLASS_NAMES[0])
for image_path in roses[:3]:
    display.display(Image.open(str(image_path)))
    
roses = list(data_dir.glob(CLASS_NAMES[1] + '/*'))
